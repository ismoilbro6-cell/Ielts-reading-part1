...
export const passage1: Passage = {
  ...
  questions: [
    ...
    },
    {
      id: 'p1_q7',
      type: 'tfng',
      text: 'The introduction of pneumatic tires contributed to a surge in bicycle popularity.',
      options: ['True', 'False', 'Not Given'],
      correctAnswer: 'True'
    },
    {
    ...
    },
    {
      id: 'p1_q13',
      type: 'fill-in-the-blank',
      text: 'In the 20th century, heavy frames were replaced by lighter materials such as aluminum and ________.',
